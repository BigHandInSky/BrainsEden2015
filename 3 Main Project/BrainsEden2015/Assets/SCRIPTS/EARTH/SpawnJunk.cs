...
public class SpawnJunk : MonoBehaviour 
{
	...
	void Start () {
		...
		{
			//Vector3 position = new Vector3 (Random.Range (500, 1000), Random.Range (500, 1000), 0);
			Instantiate(debrisList[i], new Vector3 (Random.Range (-15, -6), Random.Range (-15, 15), 0), Quaternion.identity);
		}

		for (int i = 0; i<3; i++) 
		{
			//Vector3 position = new Vector3 (Random.Range (500, 1000), Random.Range (500, 1000), 0);
			Instantiate(debrisList[i], new Vector3 (Random.Range (-15, 15), Random.Range (6, 15), 0), Quaternion.identity);
		}
		for (int i = 0; i<3; i++) 
		{
			//Vector3 position = new Vector3 (Random.Range (500, 1000), Random.Range (500, 1000), 0);
			Instantiate(debrisList[i], new Vector3 (Random.Range (6, 15), Random.Range (-15, 15), 0), Quaternion.identity);
		}
